...
export default function SettingsPage() {
  ...
  const inputClass =
    "rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-ink-slate outline-none transition focus:border-primary-600 focus:ring-2 focus:ring-primary-100";

  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      <h1 className="mb-1 text-2xl font-semibold text-ink-slate">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Pengiriman email akan segera tersedia; pengaturan ini
                  tersimpan.
                </p>
              </div>
            </div>
              ...
              onChange={(v) => {
                void updateSettings({ ...settings, email_enabled: v })
                  .then(() =>
                    showNotice(
                      v
                        ? "Notifikasi email diaktifkan (pengiriman menyusul)."
